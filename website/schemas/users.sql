...
INSERT INTO Cars VALUES('Mercedes-Benz A-Class','The Mercedes-Benz A-Class is a premium compact car that combines elegance, advanced technology, and impressive performance. It serves as an entry point into the Mercedes-Benz lineup, offering a luxurious and comfortable driving experience with a range of modern features.', 4, 3, 65, 53000);
...
INSERT INTO Cars VALUES('Toyota Rav4','The Toyota RAV4 is a popular compact SUV that offers a combination of style, versatility, and reliability. As one of Toyota''s best-selling vehicles, the RAV4 has established itself as a practical and capable choice for individuals and families alike.', 4, 3, 75, 63500);
